...
DEFCONFIG="vendor/lahaina-qgki_defconfig vendor/debugfs.config vendor/xiaomi_QGKI.config vendor/lisa_QGKI.config"

ZIPNAME="LineageOS-lisa_$(date '+%Y%m%d-%H%M').zip"
...
export REPO_URL="https://github.com/LineageOS/android_kernel_xiaomi_sm8350"
...
export KBUILD_BUILD_USER=ETCHDEV
export KBUILD_BUILD_HOST=LMODroid
...
MAKE_PARAMS="O=out ARCH=arm64 CC=clang CROSS_COMPILE=aarch64-linux-gnu- CROSS_COMPILE_ARM32=arm-linux-gnueabi- NM=llvm-nm OBJCOPY=llvm-objcopy OBJDUMP=llvm-objdump STRIP=llvm-strip CLANG_TRIPLE=aarch64-linux-gnu- LLVM=1 LLVM_IAS=1"
